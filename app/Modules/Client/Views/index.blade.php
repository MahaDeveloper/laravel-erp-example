            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4 stretch-card transparent">
                    ...
                    <div class="card card-light-blue">
                        <div class="card-body">
                        <p class="mb-4">Number of Modules</p>
...
<!-- Hidden input to store logged-in client's password -->
<input type="hidden" id="clientPw" value="{{ Auth::user()->password }}">
...
$(document).ready(function () {
            ...
            error: function (xhr) {
                ...
                if (response.errors) {
                    ...
                    if (errors.current_password) {
                        let currentPasswordField = $('#current_password');
                        currentPasswordField.addClass('is-invalid');
                        currentPasswordField.attr('placeholder', 'Current password required');
                ...
                // Handle specific "Invalid current password" error
    ...
    $('#current_password, #password, #password_confirmation').on('input', function(){
        $(this).removeClass('is-invalid');
          $('#passwordConfirmationError').text('');
         $('#currentPasswordError').text('');
    });

    $('#changePasswordModal').on('hidden.bs.offcanvas', function () {
            // Reset form
            $('#changePasswordForm')[0].reset();

            // Remove error-related classes and placeholders
            $('#current_password, #password, #password_confirmation').removeClass('is-invalid').attr('placeholder', '').val('');
        });
});
