...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-template/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-template/assets/vendors/ti-icons/css/themify-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin-template/assets/js/select.dataTables.min.css') }}">
  ...
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    <a class="navbar-brand brand-logo me-5" href="index.html"><img src="{{ asset('admin-template/assets/images/logo.svg') }}" class="me-2" alt="logo" /></a>
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item nav-profile dropdown">
        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
          <img src="{{ asset('admin-template/assets/images/faces/face28.jpg') }}" alt="profile" />
        </a>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card tale-bg">
                  <div class="card-people mt-auto">
                    <img src="{{ asset('admin-template/assets/images/dashboard/people.svg') }}" alt="people">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('admin-template/assets/images/faces/face1.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('admin-template/assets/images/faces/face2.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('admin-template/assets/images/faces/face3.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('admin-template/assets/images/faces/face4.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('admin-template/assets/images/faces/face5.jpg') }}" alt="user">
                          <div>
...
<script src="{{ asset('admin-template/assets/js/dataTables.select.min.js') }}"></script>
